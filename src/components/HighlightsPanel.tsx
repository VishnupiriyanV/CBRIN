...
/** Format an ISO datetime string into a relative time string like "2h ago" */
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-hairline bg-canvas">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full border border-accent-sunset/40 bg-accent-sunset/10 flex items-center justify-center text-accent-sunset">
          ...
          <div className="flex items-center gap-2">
            {highlights.length > 0 && (
              <button
                ...
                className="px-3 py-1.5 rounded-full border border-hairline bg-canvas-soft hover:border-hairline-bright text-xs font-medium text-ink transition-all flex items-center gap-1.5"
        ...
        <div className="p-6 overflow-y-auto space-y-3">
          {highlights.length === 0 ? (
            <div className="text-center py-12 space-y-3">
              <div className="w-12 h-12 rounded-full border border-hairline-bright bg-canvas-soft mx-auto flex items-center justify-center text-ink-mute">
            ...
            highlights.map((h) => (
              <div
                key={h.chunk_id}
                className="bg-canvas-soft border border-hairline rounded-lg p-4 hover:border-hairline-bright transition-all group"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    <h4 className="text-sm font-medium text-ink truncate group-hover:text-accent-sunset transition-colors">
                      {h.video_title}
                    </h4>

                    {h.section_topic && (
                      <div className="flex items-center gap-1 text-[10px] font-mono text-ink-mute">
                        <Layers className="w-3 h-3 text-accent-sunset" />
                    ...
                    {h.note && (
                      <div className="flex items-start gap-1.5 text-[11px] text-ink-mute">
                        <MessageSquare className="w-3 h-3 mt-0.5 text-accent-sunset shrink-0" />
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button
                      ...
                      className="p-2 text-ink-mute hover:text-accent-sunset hover:bg-canvas rounded-full transition-colors"
                    ...
                    <button
                      ...
                      className="p-2 text-ink-mute hover:text-red-400 hover:bg-canvas rounded-full transition-colors"
